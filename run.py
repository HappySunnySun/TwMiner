...
twitch_miner = TwitchChannelPointsMiner(
    username="happysunnysun_",
    password="SunnyStreaming!67",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1349683096802295839/KUtLU0pJF5MlIj6ixSyLzkUddP_1Ivhty-uLDAEP6PAdghXD1r7LSsIr9piizI8bmpQU",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.CHAT_MENTION],                                  # Only these events will be sent to the chat
        ),
        webhook=Webhook(
